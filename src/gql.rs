...
pub const OP_COMBINED_LISTS: &str = "GAZ30-3p0JcgcYvPNA0IJw/CombinedLists";
pub const OP_LIST_BY_REST_ID: &str = "t9AbdyHaJVfjL9jsODwgpQ/ListByRestId";
pub const OP_LIST_BY_SLUG: &str = "LDQpQ89B5ipR8izCKrWU0g/ListBySlug";
pub const OP_LIST_LATEST_TWEETS_TIMELINE: &str = "7UuJsFvnWuZo0HmxrzU42Q/ListLatestTweetsTimeline";
pub const OP_LIST_MEMBERS: &str = "oIetCo19avgStX4mOnGsPg/ListMembers";
pub const OP_LIST_MEMBERSHIPS: &str = "hn9KY-pZkh-oRBVAtYcpSQ/ListMemberships";
pub const OP_LIST_OWNERSHIPS: &str = "5eUATiy7RZHeOMVM5ZZIcg/ListOwnerships";
pub const OP_LIST_RANKED_TWEETS_TIMELINE: &str = "k6XNxM7f9JrrqcITWhkv0Q/ListRankedTweetsTimeline";
pub const OP_LIST_SUBSCRIBERS: &str = "3oBsFck-psIlbswYUEh3pQ/ListSubscribers";
